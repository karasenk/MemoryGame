...
class LevelVeryEasyActivity : AppCompatActivity() {
    ...
    private val BEST_SCORE_KEY = "best_score_very_easy"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level_very_easy)
    ...
    private val TOTAL_PAIRS = 2 // Добавляем константу
    ...
    private fun gameCompleted() {
        ...
        val intent = Intent(this, LevelResultActivity::class.java).apply {
            ...
            putExtra("LEVEL_NAME", "Очень Легко") // Для каждого уровня свое имя
